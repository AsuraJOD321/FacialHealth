...
const Analysis = () => {
  ...
  const captureAndAnalyze = () => {
    ...
    if (imageSrc) runAnalysis(imageSrc);
  };

  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-3xl font-bold mb-2">Facial Skin Analysis</h1>
        <p className="text-muted-foreground mb-8">
          Upload a photo or use your webcam to analyze your skin conditions using AI.
        </p>
      </motion.div>
      ...
      <Tabs defaultValue="upload">
        ...
        <TabsContent value="upload">
          ...
          <div className="mt-6">
            <Button
              onClick={() => preview && runAnalysis(preview)}
